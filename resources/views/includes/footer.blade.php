        ...
        <div class="row"> 
            ...
            <div class="col-md-3 col-sm-6">
                ...
                <ul class="quicklinks">
                    ...
                    <li><a href="{{ route('contact.us') }}">{{__('Contactez-nous')}}</a></li>
                    <li class="postad"><a href="{{ route('post.job') }}">{{__('Publiez une offre')}}</a></li>
...
<div class="copyright">
    <div class="container">
        <div class="row">
            <div class="col-md-8">
                <div class="bttxt">{{__('Copyright')}} &copy; {{date('Y')}} {{ $siteSetting->site_name }}. {{__('All Rights Reserved')}}. {{__('Design by')}}: <a href="{{url('/')}}https://www.univ-guyane.fr" target="_blank">Université de Guyane</a></div>
            </div>
            <div class="col-md-4">
