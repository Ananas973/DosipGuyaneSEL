<div class="col-lg-3">
    ...
    <div class="switchbox">
        <div class="txtlbl">{{__('Disponible maintenant')}} <i class="fa fa-info-circle" data-toggle="popover" data-trigger="hover" data-placement="top" data-content="{{__('Are you immediate available')}}?" data-original-title="{{__('Are you immediate available')}}?" title="{{__('Êtes-vous disponible maintenant')}}?"></i>
        </div>
        <div class="">
    ...
    <ul class="usernavdash">
        <li class="active"><a href="{{route('home')}}"><i class="fa fa-tachometer" aria-hidden="true"></i> {{__('Tableau de bord')}}</a>
        </li>
